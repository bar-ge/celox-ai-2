...
| `WA_ANTHROPIC_MODEL` | optional; defaults to `claude-3-5-haiku-20241022` |
| `WA_ANTHROPIC_FALLBACK_MODEL` | optional; defaults to `claude-3-5-sonnet-20241022`, used if the primary model is unavailable |
