          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <button onClick={() => handleOAuth('google')} style={{
                ...
                color: C.text, width: '100%', transition: 'border-color 0.15s, box-shadow 0.15s',
              }}
              ...
              <button onClick={() => handleOAuth('azure')} style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = '#0078D4'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(0,120,212,0.12)' }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = C.border; e.currentTarget.style.boxShadow = 'none' }}
              >
                {/* Microsoft icon */}
